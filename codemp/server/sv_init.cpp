...
static void SV_InitRef( void ) {
	...
	R_Error = Com_Error;
	Com_OPrintf = Com_OPrintf;
	Sys_Milliseconds2 = Sys_Milliseconds2; //FIXME: unix+mac need this
	Hunk_AllocateTempMemory = Hunk_AllocateTempMemory;
	Hunk_FreeTempMemory = Hunk_FreeTempMemory;
	Hunk_Alloc = Hunk_Alloc;
	Hunk_MemoryRemaining = Hunk_MemoryRemaining;
	Z_Malloc = Z_Malloc;
	Z_Free = Z_Free;
	Z_MemSize = Z_MemSize;
	Z_MorphMallocTag = Z_MorphMallocTag;
	Cmd_ExecuteString = Cmd_ExecuteString;
	Cmd_Argc = Cmd_Argc;
	Cmd_Argv = Cmd_Argv;
	Cmd_ArgsBuffer = Cmd_ArgsBuffer;
	Cmd_AddCommand = Cmd_AddCommand;
	Cmd_RemoveCommand = Cmd_RemoveCommand;
	Cvar_Set = Cvar_Set;
	Cvar_Get = Cvar_Get;
	Cvar_VariableStringBuffer = Cvar_VariableStringBuffer;
	Cvar_VariableString = Cvar_VariableString;
	Cvar_VariableValue = Cvar_VariableValue;
	Cvar_VariableIntegerValue = Cvar_VariableIntegerValue;
	Sys_LowPhysicalMemory = Sys_LowPhysicalMemory;
	SE_GetString = SE_GetString;
	...
	FS_FOpenFileWrite = FS_FOpenFileWrite;
	FS_FOpenFileByMode = FS_FOpenFileByMode;
	...
	CM_DrawDebugSurface = CM_DrawDebugSurface;
//	CM_CullWorldBox = CM_CullWorldBox;
...
//	ri.CM_ShutdownTerrain = CM_ShutdownTerrain;
	CM_ClusterPVS = CM_ClusterPVS;
	CM_LeafArea = CM_LeafArea;
	CM_LeafCluster = CM_LeafCluster;
	CM_PointLeafnum = CM_PointLeafnum;
	CM_PointContents = CM_PointContents;
	Com_TheHunkMarkHasBeenMade = Com_TheHunkMarkHasBeenMade;
