...
public:
	...
	{
		RE_AddPolyToScene( shader, count, verts, 1 );
	}
	...
	{
		RE_AddDecalToScene ( shader, origin, dir, orientation, r, g, b, a, alphaFade, radius, temporary );
	}
