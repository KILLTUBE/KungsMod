...
public:
	...
	int &handle_image_in_opacity       = default_link_inputs[4].val_i = 0; // only red channel
	int &handle_image_in_gloss         = default_link_inputs[5].val_i = 0; // only red channel
	int &handle_image_in_height        = default_link_inputs[6].val_i = 0; // only red channel
