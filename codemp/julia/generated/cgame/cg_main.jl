...
CG_Argv( arg_ ) = ccall((:CG_Argv, lib), Ptr{Char}, ( Int32,  ), arg_ );
...
CG_GetStringEdString( refSection_, refName_ ) = ccall((:CG_GetStringEdString, lib), Ptr{Char}, ( Ptr{Char}, Ptr{Char},  ), refSection_, refName_ );
...
CG_ConfigString( index_ ) = ccall((:CG_ConfigString, lib), Ptr{Char}, ( Int32,  ), index_ );
CG_StartMusic( bForceStart_ ) = ccall((:CG_StartMusic, lib), Void, ( qboolean,  ), bForceStart_ );
CG_GetMenuBuffer( filename_ ) = ccall((:CG_GetMenuBuffer, lib), Ptr{Char}, ( Ptr{Char},  ), filename_ );
...
CG_InfoFromScoreIndex( index_, team_, scoreIndex_ ) = ccall((:CG_InfoFromScoreIndex, lib), Ptr{clientInfo_t}, ( Int32, Int32, Ptr{Int32},  ), index_, team_, scoreIndex_ );
CG_FeederItemText( feederID_, index_, column_, handle1_, handle2_, handle3_ ) = ccall((:CG_FeederItemText, lib), Ptr{Char}, ( Float32, Int32, Int32, Ptr{qhandle_t}, Ptr{qhandle_t}, Ptr{qhandle_t},  ), feederID_, index_, column_, handle1_, handle2_, handle3_ );
...
CG_GetLocationString( loc_ ) = ccall((:CG_GetLocationString, lib), Ptr{Char}, ( Ptr{Char},  ), loc_ );
...
CG_GetOriginTrajectory( entID_ ) = ccall((:CG_GetOriginTrajectory, lib), Ptr{trajectory_t}, ( Int32,  ), entID_ );
CG_GetAngleTrajectory( entID_ ) = ccall((:CG_GetAngleTrajectory, lib), Ptr{trajectory_t}, ( Int32,  ), entID_ );
