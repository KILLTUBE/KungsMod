...
FX_AddOrientedLine( start_, end_, normal_, stScale_, scale_, dscale_, startalpha_, endalpha_, killTime_, shader_ ) = ccall((:FX_AddOrientedLine, lib), Ptr{localEntity_t}, ( vec3_t, vec3_t, vec3_t, Float32, Float32, Float32, Float32, Float32, Float32, qhandle_t,  ), start_, end_, normal_, stScale_, scale_, dscale_, startalpha_, endalpha_, killTime_, shader_ );
