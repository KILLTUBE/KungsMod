CG_PlaceString( rank_ ) = ccall((:CG_PlaceString, lib), Char, ( Int32,  ), rank_ );
...
CG_TeamName( team_ ) = ccall((:CG_TeamName, lib), Char, ( Int32,  ), team_ );
...
CG_GetStringForVoiceSound( s_ ) = ccall((:CG_GetStringForVoiceSound, lib), Char, ( Ptr{Char},  ), s_ );
