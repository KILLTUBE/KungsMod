...
NPC_PickEnemy( closestTo_, enemyTeam_, checkVis_, findPlayersFirst_, findClosest_ ) = ccall((:NPC_PickEnemy, lib), Ptr{gentity_t}, ( Ptr{gentity_t}, Int32, qboolean, qboolean, qboolean,  ), closestTo_, enemyTeam_, checkVis_, findPlayersFirst_, findClosest_ );
NPC_PickAlly( facingEachOther_, range_, ignoreGroup_, movingOnly_ ) = ccall((:NPC_PickAlly, lib), Ptr{gentity_t}, ( qboolean, Float32, qboolean, qboolean,  ), facingEachOther_, range_, ignoreGroup_, movingOnly_ );
NPC_CheckEnemy( findNew_, tooFarOk_, setEnemy_ ) = ccall((:NPC_CheckEnemy, lib), Ptr{gentity_t}, ( qboolean, qboolean, qboolean,  ), findNew_, tooFarOk_, setEnemy_ );
...
NPC_SearchForWeapons() = ccall((:NPC_SearchForWeapons, lib), Ptr{gentity_t}, (),  );
