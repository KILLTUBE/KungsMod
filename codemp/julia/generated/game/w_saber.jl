...
G_KickTrace( ent_, kickDir_, kickDist_, kickEnd_, kickDamage_, kickPush_ ) = ccall((:G_KickTrace, lib), gentity_t, ( Ptr{gentity_t}, vec3_t, Float32, vec3_t, Int32, Float32,  ), ent_, kickDir_, kickDist_, kickEnd_, kickDamage_, kickPush_ );
