...
WP_FireThermalDetonator( ent_, altFire_ ) = ccall((:WP_FireThermalDetonator, lib), gentity_t, ( Ptr{gentity_t}, qboolean,  ), ent_, altFire_ );
WP_DropThermal( ent_ ) = ccall((:WP_DropThermal, lib), gentity_t, ( Ptr{gentity_t},  ), ent_ );
...
WP_FireVehicleWeapon( ent_, start_, dir_, vehWeapon_, alt_fire_, isTurretWeap_ ) = ccall((:WP_FireVehicleWeapon, lib), gentity_t, ( Ptr{gentity_t}, vec3_t, vec3_t, Ptr{vehWeaponInfo_t}, qboolean, qboolean,  ), ent_, start_, dir_, vehWeapon_, alt_fire_, isTurretWeap_ );
