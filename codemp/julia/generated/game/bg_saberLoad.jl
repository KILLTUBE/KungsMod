...
SaberColorToString( color_ ) = ccall((:SaberColorToString, lib), Ptr{Char}, ( saber_colors_t,  ), color_ );
...
KeywordHash_Find( table_, keyword_ ) = ccall((:KeywordHash_Find, lib), Ptr{keywordHash_t}, ( Ptr{keywordHash_t}, Ptr{Char},  ), table_, keyword_ );
