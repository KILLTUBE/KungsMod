...
CreateMissile( org_, dir_, vel_, life_, owner_, altFire_ ) = ccall((:CreateMissile, lib), Ptr{gentity_t}, ( vec3_t, vec3_t, Float32, Int32, Ptr{gentity_t}, qboolean,  ), org_, dir_, vel_, life_, owner_, altFire_ );
