...
EWeb_Create( spawner_ ) = ccall((:EWeb_Create, lib), gentity_t, ( Ptr{gentity_t},  ), spawner_ );
...
LaunchItem( item_, origin_, velocity_ ) = ccall((:LaunchItem, lib), gentity_t, ( Ptr{gitem_t}, vec3_t, vec3_t,  ), item_, origin_, velocity_ );
Drop_Item( ent_, item_, angle_ ) = ccall((:Drop_Item, lib), gentity_t, ( Ptr{gentity_t}, Ptr{gitem_t}, Float32,  ), ent_, item_, angle_ );
