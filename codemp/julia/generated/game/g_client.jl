...
SelectNearestDeathmatchSpawnPoint( from_ ) = ccall((:SelectNearestDeathmatchSpawnPoint, lib), gentity_t, ( vec3_t,  ), from_ );
SelectRandomDeathmatchSpawnPoint( isbot_ ) = ccall((:SelectRandomDeathmatchSpawnPoint, lib), gentity_t, ( qboolean,  ), isbot_ );
SelectRandomFurthestSpawnPoint( avoidPoint_, origin_, angles_, team_, isbot_ ) = ccall((:SelectRandomFurthestSpawnPoint, lib), gentity_t, ( vec3_t, vec3_t, vec3_t, team_t, qboolean,  ), avoidPoint_, origin_, angles_, team_, isbot_ );
SelectDuelSpawnPoint( team_, avoidPoint_, origin_, angles_, isbot_ ) = ccall((:SelectDuelSpawnPoint, lib), gentity_t, ( Int32, vec3_t, vec3_t, vec3_t, qboolean,  ), team_, avoidPoint_, origin_, angles_, isbot_ );
SelectSpawnPoint( avoidPoint_, origin_, angles_, team_, isbot_ ) = ccall((:SelectSpawnPoint, lib), gentity_t, ( vec3_t, vec3_t, vec3_t, team_t, qboolean,  ), avoidPoint_, origin_, angles_, team_, isbot_ );
SelectInitialSpawnPoint( origin_, angles_, team_, isbot_ ) = ccall((:SelectInitialSpawnPoint, lib), gentity_t, ( vec3_t, vec3_t, team_t, qboolean,  ), origin_, angles_, team_, isbot_ );
SelectSpectatorSpawnPoint( origin_, angles_ ) = ccall((:SelectSpectatorSpawnPoint, lib), gentity_t, ( vec3_t, vec3_t,  ), origin_, angles_ );
...
G_ValidateUserinfo( userinfo_ ) = ccall((:G_ValidateUserinfo, lib), Char, ( Ptr{Char},  ), userinfo_ );
...
ClientConnect( clientNum_, firstTime_, isBot_ ) = ccall((:ClientConnect, lib), Char, ( Int32, qboolean, qboolean,  ), clientNum_, firstTime_, isBot_ );
