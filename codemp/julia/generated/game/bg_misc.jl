...
BG_FindItemForPowerup( pw_ ) = ccall((:BG_FindItemForPowerup, lib), gitem_t, ( powerup_t,  ), pw_ );
BG_FindItemForHoldable( pw_ ) = ccall((:BG_FindItemForHoldable, lib), gitem_t, ( holdable_t,  ), pw_ );
BG_FindItemForWeapon( weapon_ ) = ccall((:BG_FindItemForWeapon, lib), gitem_t, ( weapon_t,  ), weapon_ );
BG_FindItemForAmmo( ammo_ ) = ccall((:BG_FindItemForAmmo, lib), gitem_t, ( ammo_t,  ), ammo_ );
BG_FindItem( classname_ ) = ccall((:BG_FindItem, lib), gitem_t, ( Ptr{Char},  ), classname_ );
...
BG_Alloc( size_ ) = ccall((:BG_Alloc, lib), Void, ( Int32,  ), size_ );
BG_AllocUnaligned( size_ ) = ccall((:BG_AllocUnaligned, lib), Void, ( Int32,  ), size_ );
BG_TempAlloc( size_ ) = ccall((:BG_TempAlloc, lib), Void, ( Int32,  ), size_ );
BG_TempFree( size_ ) = ccall((:BG_TempFree, lib), Void, ( Int32,  ), size_ );
BG_StringAlloc( source_ ) = ccall((:BG_StringAlloc, lib), Char, ( Ptr{Char},  ), source_ );
BG_OutOfMemory() = ccall((:BG_OutOfMemory, lib), qboolean, (),  );
BG_GetGametypeString( gametype_ ) = ccall((:BG_GetGametypeString, lib), Char, ( Int32,  ), gametype_ );
