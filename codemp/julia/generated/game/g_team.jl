...
TeamName( team_ ) = ccall((:TeamName, lib), Ptr{Char}, ( Int32,  ), team_ );
OtherTeamName( team_ ) = ccall((:OtherTeamName, lib), Ptr{Char}, ( Int32,  ), team_ );
TeamColorString( team_ ) = ccall((:TeamColorString, lib), Ptr{Char}, ( Int32,  ), team_ );
...
Team_ResetFlag( team_ ) = ccall((:Team_ResetFlag, lib), Ptr{gentity_t}, ( Int32,  ), team_ );
...
Team_GetLocation( ent_ ) = ccall((:Team_GetLocation, lib), Ptr{locationData_t}, ( Ptr{gentity_t},  ), ent_ );
...
SelectRandomTeamSpawnPoint( teamstate_, team_, siegeClass_ ) = ccall((:SelectRandomTeamSpawnPoint, lib), Ptr{gentity_t}, ( Int32, team_t, Int32,  ), teamstate_, team_, siegeClass_ );
SelectCTFSpawnPoint( team_, teamstate_, origin_, angles_, isbot_ ) = ccall((:SelectCTFSpawnPoint, lib), Ptr{gentity_t}, ( team_t, Int32, vec3_t, vec3_t, qboolean,  ), team_, teamstate_, origin_, angles_, isbot_ );
SelectSiegeSpawnPoint( siegeClass_, team_, teamstate_, origin_, angles_, isbot_ ) = ccall((:SelectSiegeSpawnPoint, lib), Ptr{gentity_t}, ( Int32, team_t, Int32, vec3_t, vec3_t, qboolean,  ), siegeClass_, team_, teamstate_, origin_, angles_, isbot_ );
