...
BuildShaderStateConfig() = ccall((:BuildShaderStateConfig, lib), Ptr{Char}, (),  );
...
G_Find( from_, fieldofs_, match_ ) = ccall((:G_Find, lib), Ptr{gentity_t}, ( Ptr{gentity_t}, Int32, Ptr{Char},  ), from_, fieldofs_, match_ );
...
G_PickTarget( targetname_ ) = ccall((:G_PickTarget, lib), Ptr{gentity_t}, ( Ptr{Char},  ), targetname_ );
...
tv( x_, y_, z_ ) = ccall((:tv, lib), Ptr{Float32}, ( Float32, Float32, Float32,  ), x_, y_, z_ );
vtos( v_ ) = ccall((:vtos, lib), Ptr{Char}, ( vec3_t,  ), v_ );
...
G_Spawn() = ccall((:G_Spawn, lib), Ptr{gentity_t}, (),  );
...
G_TempEntity( origin_, event_ ) = ccall((:G_TempEntity, lib), Ptr{gentity_t}, ( vec3_t, Int32,  ), origin_, event_ );
G_SoundTempEntity( origin_, event_, channel_ ) = ccall((:G_SoundTempEntity, lib), Ptr{gentity_t}, ( vec3_t, Int32, Int32,  ), origin_, event_, channel_ );
...
G_PlayEffect( fxID_, org_, ang_ ) = ccall((:G_PlayEffect, lib), Ptr{gentity_t}, ( Int32, vec3_t, vec3_t,  ), fxID_, org_, ang_ );
G_PlayEffectID( fxID_, org_, ang_ ) = ccall((:G_PlayEffectID, lib), Ptr{gentity_t}, ( Int32, vec3_t, vec3_t,  ), fxID_, org_, ang_ );
G_ScreenShake( org_, target_, intensity_, duration_, global_ ) = ccall((:G_ScreenShake, lib), Ptr{gentity_t}, ( vec3_t, Ptr{gentity_t}, Float32, Int32, qboolean,  ), org_, target_, intensity_, duration_, global_ );
