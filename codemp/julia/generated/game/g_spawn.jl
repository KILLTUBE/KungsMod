...
G_NewString( string_ ) = ccall((:G_NewString, lib), Ptr{Char}, ( Ptr{Char},  ), string_ );
G_NewString_Safe( string_ ) = ccall((:G_NewString_Safe, lib), Ptr{Char}, ( Ptr{Char},  ), string_ );
...
G_AddSpawnVarToken( string_ ) = ccall((:G_AddSpawnVarToken, lib), Ptr{Char}, ( Ptr{Char},  ), string_ );
