...
CCALL void Display_ExpandMacros(char * buff);
...
CCALL qboolean Script_Parse(char **p, const char **out);
...
CCALL void Menu_ShowGroup (menuDef_t *menu, const char *itemName, qboolean showFlag);
...
CCALL qboolean Display_KeyBindPending();
